...
function Home() {
    ...
    return (
        <>
            <Navbar />
            <div className=' sm:flex items-center justify-center h-5/6  flex flex-col-reverse  w-full' >
                <div className='  h-1/2 w-full flex flex-col items-center justify-center sm:h-auto text-center pt-8'>
                ...
                <div className=' flex items-end sm:justify-center justify-center sm:w-1/2 w-full sm:h-auto h-1/2  '>
